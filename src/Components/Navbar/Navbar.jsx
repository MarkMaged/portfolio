    ...
    <div>
        <nav className='mb-20 flex items-center justify-between py-6'>
            <div className='flex flex-shrink-0 items-center'>
                <img className='w-10 mx-2' src={logo} alt="Mark Maged Logo" />
            </div>
            <div className="m-8 flex items-center justify-center gap-4 text-2xl">
                <a href="https://www.linkedin.com/in/mark-maged-a017881aa/" target='_blank'><FaLinkedin></FaLinkedin></a>
                <a href="https://github.com/MarkMaged" target='_blank'><FaGithub></FaGithub></a>
